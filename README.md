...
| [Terraform Azure Setup](https://github.com/G-devops-cp/azure-terraform-iac) | Provisions Azure infrastructure with Terraform modules. | Terraform, Azure |
| [Kubernetes Java-MySQL App](https://github.com/G-devops-cp/k8s-java-mysql) | Deploys a microservice with Kubernetes and Helm, with Ingress and TLS. | Kubernetes, Helm, MySQL, Spring Boot |
